...
SRC_URI="
	...
	https://github.com/SleepyMario/mushroom-overlay/releases/download/distfiles-hugo-0.163.1/${P}-vendor.tar.xz
"
...
PATCHES=(
	"${FILESDIR}"/${PN}-0.163.1-unbundle-libsass.patch
)
...
src_compile() {
	mkdir -pv bin || die
		go build -mod=vendor -buildmode=pie \
			-ldflags "-X github.com/gohugoio/hugo/common/hugo.vendorInfo=gentoo:${PVR}" \
