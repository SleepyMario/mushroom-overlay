...
SLOT="0"
KEYWORDS="~amd64"
IUSE="+anthy cangjie chewing fbterm handwrite +hangul kkc +libpinyin rime skk sunpinyin table table-chinese table-extraphrase table-latin +typing-booster unikey"
